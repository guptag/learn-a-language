...
describe('graph tests', () => {
  ...
  it('connected nodes are set correctly', () => {
    ...
    expect(graph.getConnectedNodes(jfk)).toEqual(expect.arrayContaining([mco, atl, phx, lax]));

    expect(graph.getConnectedNodes(sea).length).toEqual(2);
    expect(graph.getConnectedNodes(sea)).toEqual(expect.arrayContaining([mco, lax]));

    expect(graph.getConnectedNodes(mco).length).toEqual(3);
    expect(graph.getConnectedNodes(mco)).toEqual(expect.arrayContaining([jfk, sea, ord]));

    expect(graph.getConnectedNodes(hou).length).toEqual(1);
    expect(graph.getConnectedNodes(hou)).toEqual(expect.arrayContaining([ord]));

    expect(graph.getConnectedNodes(atl).length).toEqual(1);
    expect(graph.getConnectedNodes(atl)).toEqual(expect.arrayContaining([jfk]));

    expect(graph.getConnectedNodes(phx).length).toEqual(1);
    expect(graph.getConnectedNodes(phx)).toEqual(expect.arrayContaining([jfk]));

    expect(graph.getConnectedNodes(ord).length).toEqual(2);
    expect(graph.getConnectedNodes(ord)).toEqual(expect.arrayContaining([mco, hou]));

    expect(graph.getConnectedNodes(lax).length).toEqual(2);
    expect(graph.getConnectedNodes(lax)).toEqual(expect.arrayContaining([sea, jfk]));

    expect(graph.getConnectedNodes(den).length).toEqual(0);
    expect(graph.getConnectedNodes(den)).toEqual(expect.arrayContaining([]));
  });
