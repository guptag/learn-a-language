...
export function isBinaryTreeSymmetric<T>(treeNode: IBinaryTreeNode<T>): boolean {
  return checkSymmetric(treeNode.left, treeNode.right);
}

function checkSymmetric<T>(leftNode: IBinaryTreeNode<T>, rightNode: IBinaryTreeNode<T>): boolean {
