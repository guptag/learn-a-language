...
import {
    isBinaryTreeBSTWithInorderTraversal,
    isBinaryTreeBSTWithRecursion,
} from './15.1-test-binary-tree-satisfies-bst';
...
describe('is binary tree BST - inorder - success tests', () => {
    it('test1', () => {
        ...
        expect(
            isBinaryTreeBSTWithInorderTraversal(binaryTree.root)
        ).toBeTruthy();
    });
